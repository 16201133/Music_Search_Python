...
def MP3_data(mp3List):
    ...
    for i in mp3List:
        ...
        MP3_utils.MP3_To_Wav(i, wav_path)  # 将MP3转换成wav文件
...
if __name__ == "__main__":
    # 1、获取需要分类的MP3列表
    path = "D:/Python/PyCharm/workspace/智能音乐搜索/音乐自动分类/mp3_address_list.txt"
    mp3List = readFile(path)
    # 2、提取MP3特征，并写入predict_data.csv
    mp3_heads,mp3_data_set = MP3_data(mp3List)
